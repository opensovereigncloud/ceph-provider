...
1. Verify the rook-ceph-operator is in the Running state before proceeding

    ```bash
    kubectl -n rook-ceph get pod
    ```

1. Create a Rook Ceph Cluster see: [Rook Docs](https://rook.io/docs/rook/v1.10/Getting-Started/example-configurations/#cluster-crd)

1. Verify cluster installation. List all rook pods again:
...
1. Build the `ceph-bucket-provider`

...
Namely `ceph-provider` implements the [`Volume`](https://github.com/ironcore-dev/ironcore/blob/main/api/storage/v1alpha1/volume_types.go)
and [`VolumePool`](https://github.com/ironcore-dev/ironcore/blob/main/api/storage/v1alpha1/volumepool_types.go) types.
